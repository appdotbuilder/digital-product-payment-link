...
export default function ProductsCreate() {
    ...
    return (
        <AppShell>
            <Head title="Tambah Produk - PayLink" />
            
            <div className="max-w-2xl mx-auto space-y-6">
                {/* Header */}
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-gray-900">➕ Tambah Produk Baru</h1>
                    <p className="text-gray-600 mt-2">Buat produk digital baru untuk dijual</p>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-medium text-blue-900 mb-1">Tips Membuat Produk</h3>
                            <ul className="text-sm text-blue-700 space-y-1">
                                <li>• Gunakan nama produk yang jelas dan menarik</li>
                                <li>• Tulis deskripsi yang menjelaskan manfaat produk</li>
                                <li>• Upload file produk agar pembeli bisa langsung download setelah membayar</li>
                                <li>• Tentukan harga yang kompetitif sesuai nilai produk Anda</li>
                            </ul>
                        </div>
                    </div>
                </div>
